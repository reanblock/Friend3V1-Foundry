...
contract Tomo is Ownable, ReentrancyGuard, Test {
    ...
    function buyVotePass(
        ...
        // @audit possible to bypass the recover check?
        ...
        // @audit gas -> better to have a price local?
        ...
        // console2.log('value', params.value);
        ...
        if (vp.owner == address(0)) {
            // @audit can subjectETHBalance be changed elsewhere?
